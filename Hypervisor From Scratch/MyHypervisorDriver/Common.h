...
#define LogInfo(format, ...)  \
    LogSendMessageToQueue(OPERATION_LOG_INFO_MESSAGE, UseImmediateMessaging, ShowSystemTimeOnDebugMessages, "(%s:%d) | " format "\n",	\
		 __func__, __LINE__, __VA_ARGS__)
...
// Log without any prefix
#define Log(format, ...)  \
    LogSendMessageToQueue(OPERATION_LOG_INFO_MESSAGE, UseImmediateMessaging, ShowSystemTimeOnDebugMessages, format, __VA_ARGS__)

#define LogMyAddress(format, ...)  \
	LogSendMessageToQueue(OPERATION_LOG_MY_ADDRESS, UseImmediateMessaging, ShowSystemTimeOnDebugMessages, format, __VA_ARGS__)
#define LogPlayersAddresses(format, ...)  \
	LogSendMessageToQueue(OPERATION_LOG_PLAYERS_ADDRESSES, UseImmediateMessaging, ShowSystemTimeOnDebugMessages, format, __VA_ARGS__)
...
ULONG64 myProcessID;
ULONG64 myAddressToHook;
int hookType;
PEPT_PML1_ENTRY entryAddressToRecover;
EPT_PML1_ENTRY entryValueToRecover;
int EPTviolationTriggered;
PGUEST_REGS curr_GuestRegs;